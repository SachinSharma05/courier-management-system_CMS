...
import { 
  AlertCircle, RotateCcw, History, Trash2, ExternalLink, Box, Cpu, X, Filter, Search
} from 'lucide-react';
import { DlqJob } from '../interface/adminInterface';
    ...
    <div className="p-2 space-y-2 bg-[#f8fafc] min-h-screen font-sans">
      ...
      <div className="mb-4 flex items-center justify-between rounded-2xl border border-slate-300 bg-white p-3 shadow-sm">
        <div className="flex items-center gap-4">
          <div className="flex h-12 w-12 bg-cyan-600 items-center justify-center rounded-xl text-white shadow-lg shadow-slate-200">
            <AlertCircle size={24} />
          </div>
          <div>
