          ...
          {!isFetched ? (
            ...
            <div className={clsx("p-10 space-y-12 transition-all duration-700", !canEdit && "opacity-40 grayscale pointer-events-none blur-[1px]")}>
              ...
              <div className="space-y-8">
                ...
                <FormGroup label="Content Inventory Description" value={form.products_desc} onChange={(v: any) => setForm({...form, products_desc: v})} disabled={!canEdit} />
              </div>
              ...
              <div className="p-8 bg-slate-50 border border-slate-100 rounded-3xl space-y-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  <FormGroup label="COD Value (INR)" value={form.cod_amount} onChange={(v: any) => setForm({...form, cod_amount: v})} disabled={!canEdit} />
                  <div className="space-y-3">
